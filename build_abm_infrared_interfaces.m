function [interfaces] = build_abm_infrared_interfaces(sample, wavelength, bifacial)
    DATA_DIR         = 'data/infrared/';
    WAVELENGTHS_FILE = [DATA_DIR, 'wavelengths.txt'];
    CELLULOSE_FILE   = [DATA_DIR, 'celluloseH.txt'];
    PROTEIN_FILE     = [DATA_DIR, 'proteinH.txt'];
    WATER_SAC_FILE   = [DATA_DIR, 'sacwH.txt'];
    WATER_RI_FILE    = [DATA_DIR, 'riH.txt'];
    CUTICLE_RI_FILE  = [DATA_DIR, 'rcH.txt'];
    ...
    mesophyllAbsorption = celluloseAbsorptionCoefficient + ...
